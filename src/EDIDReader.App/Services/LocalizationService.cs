...
internal static partial class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["当前 DP 链路"] = "Current DP link", ["当前 HDMI 链路"] = "Current HDMI link", ["当前链路"] = "Current link", ["链路等级"] = "Link rate", ["原始带宽"] = "Raw bandwidth", ["理论有效速率"] = "Theoretical payload rate", ["最大链路"] = "Maximum link", ["总可用通道"] = "Total available lanes", ["驱动未提供"] = "Not provided by the driver", ["NVIDIA 显示器映射失败"] = "NVIDIA display mapping failed", ["NVIDIA DP 信息读取失败"] = "NVIDIA DP information read failed", ["NVIDIA 输出 ID 读取失败"] = "NVIDIA output ID read failed", ["当前输出不是 NVIDIA DP"] = "The current output is not NVIDIA DP", ["NVIDIA DP 链路数据无效"] = "NVIDIA DP link data is invalid",
        ["估算 TMDS 频率"] = "Estimated TMDS frequency", ["估算 TMDS 带宽"] = "Estimated TMDS bandwidth", ["当前工作模式"] = "Current operating mode", ["FRL 或 DSC"] = "FRL or DSC", ["无法判断"] = "Cannot determine", ["无法计算"] = "Cannot calculate", ["EDID 最大像素时钟"] = "EDID maximum pixel clock",
        ...
        ["垂直频率范围"] = "Vertical frequency range", ["EDID 垂直扫描范围"] = "EDID vertical scan range", ["连接器实例"] = "Connector instance", ["当前像素时钟"] = "Current pixel clock", ["最大 TMDS 频率"] = "Maximum TMDS frequency", ["接口支持位深"] = "Supported interface bit depths", ["YCbCr 4:2:0 位深"] = "YCbCr 4:2:0 bit depths", ["最大 FRL 带宽"] = "Maximum FRL bandwidth", ["FRL 通道配置"] = "FRL lane configuration", ["EDID 接口数据块"] = "EDID interface data blocks",
        ...
        ["音频能力"] = "Audio capabilities", ["最大声道数"] = "Maximum channels", ["最高采样率"] = "Maximum sample rate", ["最高 LPCM 位深"] = "Maximum LPCM bit depth", ["支持格式"] = "Supported formats", ["格式"] = "Format", ["声道"] = "Channels", ["采样率"] = "Sample rate", ["位深"] = "Bit depth", ["位深或码率"] = "Bit depth or bitrate", ["扬声器分配"] = "Speaker allocation",
        ...
        ["外观与语言"] = "Appearance and language", ["主题"] = "Theme", ["自动"] = "Automatic", ["浅色"] = "Light", ["深色"] = "Dark", ["自动主题"] = "Automatic theme", ["浅色主题"] = "Light theme", ["深色主题"] = "Dark theme", ["语言"] = "Language", ["中文"] = "Chinese", ["英语"] = "English", ["关于"] = "About", ["版本 0.5.1"] = "Version 0.5.1", ["重命名"] = "Rename", ["删除"] = "Delete", ["删除全部"] = "Delete all", ["删除所有已保存"] = "Delete all saved records", ["删除所有已保存的显示器"] = "Delete all saved displays", ["取消"] = "Cancel", ["确认"] = "Confirm", ["保存于"] = "Saved at",
