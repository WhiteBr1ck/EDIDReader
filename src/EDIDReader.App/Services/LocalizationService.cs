...
internal static partial class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["当前 DP 链路"] = "Current DP link", ["当前 HDMI 链路"] = "Current HDMI link", ["当前链路"] = "Current link", ["链路等级"] = "Link rate", ["原始带宽"] = "Raw bandwidth", ["理论有效速率"] = "Theoretical payload rate", ["最大链路"] = "Maximum link", ["总可用通道"] = "Total available lanes", ["驱动未提供"] = "Not provided by the driver",
        ...
        ["外观与语言"] = "Appearance and language", ["主题"] = "Theme", ["自动"] = "Automatic", ["浅色"] = "Light", ["深色"] = "Dark", ["自动主题"] = "Automatic theme", ["浅色主题"] = "Light theme", ["深色主题"] = "Dark theme", ["语言"] = "Language", ["中文"] = "Chinese", ["英语"] = "English", ["关于"] = "About", ["版本 0.5.0"] = "Version 0.5.0", ["重命名"] = "Rename", ["删除"] = "Delete", ["删除全部"] = "Delete all", ["删除所有已保存"] = "Delete all saved records", ["删除所有已保存的显示器"] = "Delete all saved displays", ["取消"] = "Cancel", ["确认"] = "Confirm", ["保存于"] = "Saved at",
